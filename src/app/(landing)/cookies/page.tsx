...
export default function CookiesPage() {
  return (
    <div className="min-h-screen font-sans relative overflow-x-hidden">
      ...
      <main className="pt-32 md:pt-48 pb-24 px-6 max-w-3xl mx-auto space-y-12">
        <div className="space-y-4">
           <Heading as="h1" size="h1" className="text-soft-cream">Cookie Policy</Heading>
           <Paragraph size="xl" className="text-gray-light/60">Last updated: June 17, 2026</Paragraph>
        </div>
        ...
        <div className="prose prose-invert prose-lg max-w-none text-gray-light/90 space-y-8">
          ...
          <Heading as="h2" size="h4" className="text-white mt-8 mb-4">What are cookies?</Heading>
          <Paragraph size="lg">
            Cookies are small text files that are placed on your computer or mobile device when you visit a website. They are widely used to make websites work more efficiently and provide information to the owners of the site.
          </Paragraph>

          <Heading as="h2" size="h4" className="text-white mt-8 mb-4">How we use cookies</Heading>
          <Paragraph size="lg">
          ...
          <Heading as="h2" size="h4" className="text-white mt-8 mb-4">Your choices</Heading>
          <Paragraph size="lg">
