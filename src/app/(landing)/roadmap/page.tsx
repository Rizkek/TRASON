...
export default function RoadmapPage() {
  return (
    <div className="min-h-screen font-sans relative overflow-x-hidden">
      ...
      <main className="pt-32 md:pt-48 pb-24 px-6 max-w-7xl mx-auto space-y-24">
        {/* Presentation Header */}
        <div className="text-center space-y-6 max-w-3xl mx-auto relative z-10">
           ...
           <Paragraph size="xl" className="text-gray-light font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2 border-b border-white/10 pb-4">
                ...
                <Heading as="h2" size="h4" className="text-white">Recently Shipped</Heading>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-white/5 rounded-2xl p-6 hover:border-warm-gold/30 transition-colors">
                    <Heading as="h3" size="h6" className="text-white mb-2">{item.title}</Heading>
                    <Paragraph size="sm" className="text-gray-light">{item.desc}</Paragraph>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2 border-b border-white/10 pb-4">
                ...
                <Heading as="h2" size="h4" className="text-white">In Progress</Heading>
                ...
                {[
                  ...
                  <div key={i} className="bg-warm-gold/5 border border-warm-gold/20 rounded-2xl p-6 relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                      <Heading as="h3" size="h6" className="text-white mb-2 flex items-center gap-2">{item.title}</Heading>
                      <Paragraph size="sm" className="text-gray-light mb-4">{item.desc}</Paragraph>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-2 border-b border-white/10 pb-4">
                ...
                <Heading as="h2" size="h4" className="text-white">Up Next</Heading>
