...
export default function VitalityHabitsPage() {
  return (
    <div className="min-h-screen bg-warm-black text-soft-cream font-sans relative overflow-x-hidden">
      ...
      <div className="fixed top-[-20%] left-[20%] w-[800px] h-[800px] bg-warm-gold/5 md:blur-[160px] rounded-full pointer-events-none" style={{ transform: 'translateZ(0)', contain: 'strict' }} />
      <div className="fixed bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-warm-gold/5 md:blur-[140px] rounded-full pointer-events-none" style={{ transform: 'translateZ(0)', contain: 'strict' }} />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Vitality & Habits', item: 'https://www.trason.web.id/features/vitality-habits' }
            ]
          })
        }}
      />
