      ...
      <Card className="p-xl border border-dashed border-black/10 dark:border-white/10 bg-transparent">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-lg">
          <div className="space-y-sm w-full sm:w-auto flex-1 min-w-0">
            <p className="text-micro text-gray-light">{t('dashboard.netWorth.totalWealth')}</p>
            <h3 className="text-xl font-bold text-soft-cream">{t('dashboard.netWorth.emptyTitle')}</h3>
          ...
          <div className="shrink-0 mt-4 sm:mt-0">
            <Link href="/investments">
              <Button variant="primary" size="md">{t('dashboard.netWorth.connectBtn')}</Button>
            </Link>
          </div>
        </div>
      </Card>
      ...
      <div className="relative z-10 space-y-lg">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-md">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-xs font-bold text-gray-light uppercase tracking-widest">{t('dashboard.netWorth.title')}</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-md pt-md border-t border-white/5">
          ...
          <div className="p-lg rounded-xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/5">
            <p className="text-[10px] text-success uppercase tracking-widest mb-1 font-bold">{t('dashboard.netWorth.totalAssets')}</p>
          ...
          {/* Total Liabilities */}
          <div className="p-lg rounded-xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/5">
            <p className="text-[10px] text-danger uppercase tracking-widest mb-1 font-bold">{t('dashboard.netWorth.totalLiabilities')}</p>
