...
export function PwaInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-gray-strong border border-white/10 dark:border-white/5 rounded-xl p-4 shadow-2xl z-50 flex items-start gap-4">
      <div className="w-12 h-12 bg-black rounded-lg flex items-center justify-center flex-shrink-0 p-1 border border-white/10">
        <img src="/icon-192x192.png" alt="TRASON" className="w-full h-full object-contain" />
      </div>
