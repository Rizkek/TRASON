    ...
    <Card 
      className={`relative overflow-hidden group cursor-pointer transition-all duration-300 ${
        plan.is_active 
          ...
          : 'border-white/[0.05] hover:border-white/[0.15] bg-white/[0.02]'
      }`}
    ...
    >
      ...
      <div className="p-xl space-y-lg relative z-10">
        <div className="flex justify-between items-start gap-4">
          ...
          <div className="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-full bg-white/5 group-hover:bg-white/10 transition-colors">
            <Activity size={20} className={plan.is_active ? 'text-primary' : 'text-gray-light'} />
          </div>
        </div>

        <div className="grid grid-cols-2 gap-md">
          <div className="bg-white/5 rounded-md p-md">
        ...
        <div className="pt-sm flex items-center justify-between border-t border-white/[0.05]">
          <div className="flex items-center gap-2">
