export const es = {
  ...
  career_page: {
    ...
    ats_matcher: {
      title: 'Evaluador de Currículum ATS',
      tag: 'Analizador ATS',
      desc: 'Pega la descripción del puesto y tu CV para verificar la coincidencia.',
      jd_label: 'Descripción del Puesto',
      jd_placeholder: 'Pega las cualificaciones y la descripción del puesto aquí...',
      ...
      drag_jd_hint: 'Arrastra una descripción de empleo o pega el texto arriba',
      drag_cv_hint: 'Arrastra tu archivo de CV o pega el texto arriba',
      from_saved_app: 'Llenar desde Solicitud Guardada',
      select_app_placeholder: 'Seleccionar solicitud...',
      manual_entry: '— Ingresar manualmente o archivo —',
      clear_jd: 'Borrar descripción de puesto',
      clear_cv: 'Borrar texto del CV',
      analyze_btn: 'Analizar Coincidencia',
      score_title: 'Puntuación de Coincidencia',
      score_high_tip: 'Alta coincidencia. Tu CV se alinea bien con los requisitos.',
      score_mid_tip: 'Coincidencia moderada. Considera añadir las palabras clave faltantes.',
      score_low_tip: 'Baja coincidencia. Ajusta tu CV para los requisitos clave.',
  ...
  insights_page: {
    ...
    architect_perspective_desc: 'TRASON reúne tu ritmo diario y tus recursos en un resumen claro. Sigue registrando para ver patrones a largo plazo.',
  ...
  reminders_page: {
    title: 'Recordatorios',
    title_highlight: '',
    desc: 'Mantén el control de lo importante.',
  ...
  finance: {
    title: 'Finanzas',
    subtitle: 'Tu dinero, con claridad.',
