...
1. **Dashboard Utama (Home)***Overview* holistik dari segala aktivitas harian. Mengambil ikhtisar dari modul finansial, statistik vitalitas, *insights* investasi, dan menampilkan kalender *to-do list*.
2. **Finance Module**
